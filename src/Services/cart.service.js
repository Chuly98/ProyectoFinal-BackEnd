...
class CartService {
    ...
    async purchaseCart(cartId, userEmail) {
        ...
        <div class="text-left mb-8">
            <p class="text-lg mb-4"><span class="font-bold">Code To Ticket:</span> ${ticket.code
                    }</p>
            <p class="text-lg mb-4"><span class="font-bold">Date for Purchase:</span> ${ticket.purchase_datetime
                    }</p>
            <p class="text-lg mb-4"><span class="font-bold">User:</span> ${ticket.purchaser
                    }</p>
